...
Revision ID: 4b505c00245
Revises: 544673ac99ab
Create Date: 2015-06-28 09:23:46.115725

"""

# revision identifiers, used by Alembic.
revision = '4b505c00245'
...
def upgrade():
    ...
    sa.Column('vlink_ip_subnet', mysql.VARCHAR(length=32), server_default=sa.text(u"''"), nullable=False),
    sa.Column('vdom_name', mysql.VARCHAR(length=11), nullable=True),
    sa.Column('vlan_id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    ...
    sa.Column('allocated', mysql.TINYINT(display_width=1), autoincrement=False, nullable=True),
    sa.Column('bound', mysql.TINYINT(display_width=1), autoincrement=False, nullable=True),
